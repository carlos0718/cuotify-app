  ...
  return (
    ...
    >
      ...
      <Tabs.Screen
        ...
        listeners={{
          tabPress: () => {
            // Resetear el stack de préstamos al index cuando se presiona el tab
            router.replace('/(main)/loans');
          },
        }}
      />
      <Tabs.Screen
        ...
        options={{
          title: 'Mis Deudas',
          tabBarIcon: ({ color }) => <DebtsIcon color={color} />,
        }}
      />
      <Tabs.Screen
        name="calendar"
      ...
      <Tabs.Screen
        name="notifications"
        options={{
          href: null, // Oculto del tab bar, accesible desde el header del dashboard
        }}
      />
      <Tabs.Screen
        name="settings"
...
const styles = StyleSheet.create({
  tabBar: {
    ...
    paddingTop: 8,
    // paddingBottom y height se calculan dinámicamente con SafeAreaInsets
  },
  tabBarLabel: {
